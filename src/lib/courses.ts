...
export const COURSE_PRESETS: CoursePreset[] = [
  ...
  { id: "angel-park-palm", name: "Angel Park Golf Club (Palm course)", city: "Las Vegas, NV", region: "NV", access: "public", holes: 18, pars: p(18, 70) },
  ...
  { id: "sand-hollow-championship", name: "Sand Hollow Resort Golf Course (Championship)", city: "Hurricane, UT", region: "UT", access: "resort", holes: 18, pars: p(18, 72) },
  ...
  { id: "entrada-snow-canyon", name: "Entrada at Snow Canyon", city: "St. George, UT", region: "UT", access: "private", holes: 18, pars: p(18, 72) },
  ...
  { id: "promontory-pete-dye", name: "Promontory Club (Pete Dye Canyon Golf Club)", city: "Park City, UT", region: "UT", access: "private", holes: 18, pars: p(18, 72) },
  { id: "promontory-nicklaus", name: "Promontory Club (Painted Valley Golf Club)", city: "Park City, UT", region: "UT", access: "private", holes: 18, pars: p(18, 72) },
  ...
  { id: "glenwild", name: "Glenwild Golf Club and Spa", city: "Park City, UT", region: "UT", access: "private", holes: 18, pars: p(18, 71) },
  ...
  { id: "soldier-hollow-gold", name: "Soldier Hollow Golf Course (Gold Course)", city: "Midway, UT", region: "UT", access: "public", holes: 18, pars: p(18, 72) },

  // --- Florida ---
  { id: "tpc-sawgrass-stadium", name: "TPC Sawgrass (Stadium)", city: "Ponte Vedra Beach, FL", region: "FL", access: "resort", holes: 18, pars: p(18, 72) },
  { id: "tpc-sawgrass-dyes-valley", name: "TPC Sawgrass (Dye Valley)", city: "Ponte Vedra Beach, FL", region: "FL", access: "resort", holes: 18, pars: p(18, 71) },
  ...
  { id: "trump-doral-blue-monster", name: "Doral Golf Resort and Spa (The Blue Monster)", city: "Miami, FL", region: "FL", access: "resort", holes: 18, pars: p(18, 72) },
  { id: "trump-doral-red-tiger", name: "Doral Golf Resort & Spa (Red course)", city: "Miami, FL", region: "FL", access: "resort", holes: 18, pars: p(18, 71) },
  { id: "trump-doral-gold", name: "Doral Golf Resort & Spa (Gold course)", city: "Miami, FL", region: "FL", access: "resort", holes: 18, pars: p(18, 70) },
  { id: "bay-hill-championship", name: "Bay Hill Club & Lodge", city: "Orlando, FL", region: "FL", access: "public", holes: 18, pars: p(18, 72) },
  { id: "pga-national-champion", name: "PGA National Resort & Spa (Champion)", city: "Palm Beach Gardens, FL", region: "FL", access: "resort", holes: 18, pars: p(18, 72) },
  { id: "pga-national-palmer", name: "PGA National Resort & Spa (Palmer)", city: "Palm Beach Gardens, FL", region: "FL", access: "resort", holes: 18, pars: p(18, 72) },
  { id: "pga-national-squire", name: "PGA National Resort & Spa (Squire)", city: "Palm Beach Gardens, FL", region: "FL", access: "resort", holes: 18, pars: p(18, 72) },
  { id: "pga-national-estate", name: "PGA National Resort & Spa (Estates)", city: "Palm Beach Gardens, FL", region: "FL", access: "resort", holes: 18, pars: p(18, 72) },
  ...
  { id: "innisbrook-copperhead", name: "Westin Innisbrook Resort (Copperhead Course)", city: "Palm Harbor, FL", region: "FL", access: "resort", holes: 18, pars: p(18, 71) },
  { id: "innisbrook-island", name: "Westin Innisbrook Resort (Island)", city: "Palm Harbor, FL", region: "FL", access: "resort", holes: 18, pars: p(18, 72) },
  ...
  { id: "black-diamond-ranch-quarry", name: "Black Diamond Ranch and C.C. (Quarry Course)", city: "Lecanto, FL", region: "FL", access: "public", holes: 18, pars: p(18, 72) },

  // --- Carolinas (NC + SC) ---
  { id: "pinehurst-no-2", name: "Pinehurst Resort #2", city: "Pinehurst, NC", region: "CAR", access: "resort", holes: 18, pars: p(18, 72) },
  { id: "pinehurst-no-4", name: "Pinehurst Resort #4", city: "Pinehurst, NC", region: "CAR", access: "resort", holes: 18, pars: p(18, 72) },
  { id: "pinehurst-no-6", name: "Pinehurst Resort #6", city: "Pinehurst, NC", region: "CAR", access: "resort", holes: 18, pars: p(18, 72) },
  { id: "pinehurst-no-7", name: "Pinehurst Resort #7", city: "Pinehurst, NC", region: "CAR", access: "resort", holes: 18, pars: p(18, 72) },
  { id: "pinehurst-no-8", name: "Pinehurst Resort #8", city: "Pinehurst, NC", region: "CAR", access: "resort", holes: 18, pars: p(18, 72) },
  ...
  { id: "kiawah-ocean", name: "Kiawah Island Resort (Ocean Course)", city: "Kiawah Island, SC", region: "CAR", access: "resort", holes: 18, pars: p(18, 72) },
  { id: "kiawah-turtle-point", name: "Turtle Point Golf Course at Kiawah Island Resort", city: "Kiawah Island, SC", region: "CAR", access: "resort", holes: 18, pars: p(18, 72) },
  ...
  { id: "blackwolf-run-river", name: "Blackwolf Run Golf Club (River Course)", city: "Kohler, WI", region: "MW", access: "resort", holes: 18, pars: p(18, 72) },
  { id: "blackwolf-run-meadow-valleys", name: "Blackwolf Run Golf Course", city: "Kohler, WI", region: "MW", access: "resort", holes: 18, pars: p(18, 72) },
  ...
  { id: "cog-hill-dubsdread", name: "Cog Hill Golf & CC (Dubsdread)", city: "Lemont, IL", region: "MW", access: "public", holes: 18, pars: p(18, 72) },
  ...
  { id: "medinah-no-3", name: "Medinah Country Club (Course 3)", city: "Medinah, IL", region: "MW", access: "private", holes: 18, pars: p(18, 72) },
  ...
  { id: "pronghorn-nicklaus", name: "Pronghorn Golf Club (Nicklaus)", city: "Bend, OR", region: "PNW", access: "private", holes: 18, pars: p(18, 72) },
  { id: "pronghorn-fazio", name: "Pronghorn Golf Club (Fazio)", city: "Bend, OR", region: "PNW", access: "private", holes: 18, pars: p(18, 72) },
  ...
  { id: "heron-lakes-great-blue", name: "Heron Lakes Golf Club (Great Blue course)", city: "Portland, OR", region: "PNW", access: "public", holes: 18, pars: p(18, 72) },
  { id: "heron-lakes-greenback", name: "Heron Lakes G.C. (Greenback course)", city: "Portland, OR", region: "PNW", access: "public", holes: 18, pars: p(18, 72) },
  ...
  { id: "tumble-creek", name: "Suncadia Resort (Tumble Creek)", city: "Cle Elum, WA", region: "PNW", access: "private", holes: 18, pars: p(18, 72) },
  { id: "suncadia-prospector", name: "Suncadia Resort (Prospector)", city: "Cle Elum, WA", region: "PNW", access: "resort", holes: 18, pars: p(18, 72) },
  { id: "suncadia-rope-rider", name: "Suncadia Resort (Rope Rider)", city: "Cle Elum, WA", region: "PNW", access: "resort", holes: 18, pars: p(18, 72) },
  ...
  { id: "gold-mountain-olympic", name: "Gold Mountain Golf Course - Olympic Course", city: "Bremerton, WA", region: "PNW", access: "municipal", holes: 18, pars: p(18, 72) },
  { id: "gold-mountain-cascade", name: "Gold Mountain Golf Course - Cascade Course", city: "Bremerton, WA", region: "PNW", access: "municipal", holes: 18, pars: p(18, 71) },
  { id: "newcastle-coal-creek", name: "Golf Club at Newcastle (Coal Creek)", city: "Newcastle, WA", region: "PNW", access: "public", holes: 18, pars: p(18, 72) },
  { id: "newcastle-china-creek", name: "Golf Club at Newcastle (China Creek)", city: "Newcastle, WA", region: "PNW", access: "public", holes: 18, pars: p(18, 71) },
  ...
  { id: "bayonet", name: "Bayonet/Black Horse Golf Course (Bayonet)", city: "Seaside, CA", region: "NC", access: "public", holes: 18, pars: p(18, 72) },
  { id: "black-horse", name: "Bayonet/Black Horse Golf Course (Black Horse)", city: "Seaside, CA", region: "NC", access: "public", holes: 18, pars: p(18, 72) },
